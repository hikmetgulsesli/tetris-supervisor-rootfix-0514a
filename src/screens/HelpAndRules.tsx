...
export function HelpAndRules({ actions }: HelpAndRulesProps) {
  return (
    <>
      <header>
          <div><div className="meta">Tetris Supervisor Root Fix 0514a PRD</div><h1>Help and Rules</h1><p>Help and Rules screen generated by local fallback design assets</p></div>
