...
export function PauseOverlay({ actions }: PauseOverlayProps) {
  return (
    <>
      <header>
          <div><div className="meta">Tetris Supervisor Root Fix 0514a PRD</div><h1>Pause Overlay</h1><p>Pause Overlay screen generated by local fallback design assets</p></div>
